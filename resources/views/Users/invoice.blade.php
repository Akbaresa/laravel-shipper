      ...
      <div class="col-lg-12 col-xl-7">
        <div class="card">
          <div class="card-body p-5">
            ...
            <p class="fs-sm">
              Ini adalah tanda terima pembayaran <strong>Rp.{{ $gudang->harga_sewa }}</strong>
            </p>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <p class="fs-sm">
                    {{ $user->alamat }}
                    <br>
                    <a href="#!" class="text-purple">{{ $user->email }}
                    </a>
                  </p>
                </div>
                <div class="col-md-6 text-md-end">
                  ...
                  <p class="fs-sm">
                    {{ $gudang->lokasi }}
                    <br>
                    <a href="#!" class="text-purple">esa@email.com
                    </a>
                  </p>
                </div>
              </div>
            ...
            <table class="table border-bottom border-gray-200 mt-3">
              ...
              <tbody>
                <tr>
                  <td class="px-0">{{ $gudang->nama }}</td>
                  <td class="text-end px-0">Rp.{{ $gudang->harga_sewa }}</td>
                </tr>
              </tbody>
            </table>
            ...
            <div class="mt-5">
              ...
              <div class="d-flex justify-content-end mt-3">
                ...
                <h5 class="text-success"> Rp.{{ $gudang->harga_sewa }}</h5>
              </div>
            </div>
          </div>
